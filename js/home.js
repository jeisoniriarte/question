!(function (e, t) {
		...
		return (
			n ||
				...
				('none' !== n && n) ||
					...
					(t = (Qe[0].contentWindow || Qe[0].contentDocument)
						.document),
					t.write(),
					t.close(),
					(n = N(e, t)),
	...
	function F(e, t, n) {
		...
		n.queue ||
			...
			1 === e.nodeType &&
				...
				'inline' ===
					('none' === u
						? ie._data(e, 'olddisplay') || E(e.nodeName)
						: u) &&
					'none' === ie.css(e, 'float') &&
						...
						for (r in i)
							(e = a[r]),
								...
								a !== n &&
									(u &&
									n &&
									(ie.isPlainObject(n) || (t = ie.isArray(n)))
										? (t
												? ((t = !1),
												  (o =
														e && ie.isArray(e)
						  ...
						  (b.qsa = me.test(r.querySelectorAll)) &&
								(i(function (e) {
									(L.appendChild(e).innerHTML =
										...
										e.querySelectorAll('[id~=' + O + '-]')
											.length || q.push('~='),
										e.querySelectorAll(':checked').length ||
											q.push(':checked'),
										e.querySelectorAll('a#' + O + '+*')
											.length || q.push('.#.+[+~]');
								}),
								i(function (e) {
	...
	ie.extend({
		...
		ie.fn.extend({
			...
			add: function (e, t) {
				return this.pushStack(
					ie.unique(ie.merge(this.get(), ie(e, t)))
				);
			},
			addBack: function (e) {
				return this.add(
	...
	(ie.event = {
							...
							(d = ie.extend(
								{
									...
									selector: i,
									needsContext:
										i && ie.expr.match.needsContext.test(i),
									namespace: h.join('.'),
								},
								l
							)),
		...
		remove: function (e, t, n, r, i) {
			...
			if (g && (c = g.events)) {
				...
				ie.isEmptyObject(c) &&
					(delete g.handle, ie._removeData(e, 'events'));
			}
		},
	...
	(Je.optgroup = Je.option),
		...
		ie.fn.extend({
			...
			domManip: function (e, t) {
				...
				if (
					...
					for (
						o = ie.map(g(s, 'script'), b), i = o.length;
						u > l;
						l++
					)
						(r = s),
		...
		ie.each(
			...
			function (e, t) {
				ie.fn[e] = function (e) {
					for (
						var n, r = 0, i = [], o = ie(e), a = o.length - 1;
						a >= r;
						r++
					)
				...
				if (e && 3 !== o && 8 !== o && 2 !== o)
					return typeof e.getAttribute === Te
						...
						: ((1 === o && ie.isXMLDoc(e)) ||
								...
								(r =
									ie.attrHooks[t] ||
									(ie.expr.match.bool.test(t) ? wt : xt))),
						  void 0 === n
			...
			ajax: function (e, t) {
				function n(e, t, n, r) {
					...
					2 !== b &&
						...
						(w.statusText = (t || T) + ''),
						i
							? h.resolveWith(f, [c, T, w])
							: h.rejectWith(f, [w, T, v]),
						w.statusCode(g),
						(g = void 0),
						l &&
							p.trigger(i ? 'ajaxSuccess' : 'ajaxError', [
								w,
								d,
								i ? c : v,
							]),
				...
				(l = ie.event && d.global),
					...
					d.ifModified &&
						...
						ie.etag[o] &&
							w.setRequestHeader('If-None-Match', ie.etag[o])),
		...
		(ie.expr.filters.hidden = function (e) {
			return (
				...
				(!ne.reliableHiddenOffsets() &&
					'none' ===
						((e.style && e.style.display) || ie.css(e, 'display')))
			);
		}),
	...
	(ie.fn.load = function (e, t, n) {
		...
		return (
			s >= 0 &&
				((r = ie.trim(e.slice(s, e.length))), (e = e.slice(0, s))),
			ie.isFunction(t)
				? ((n = t), (t = void 0))
	...
	(ie.offset = {
		...
		ie.each(['top', 'left'], function (e, t) {
			ie.cssHooks[t] = k(ne.pixelPosition, function (e, n) {
				return n
					? ((n = et(e, t)),
					  nt.test(n) ? ie(e).position()[t] + 'px' : n)
					: void 0;
			});
		}),
		ie.each(
	...
	var f = Array.prototype.map,
		...
		h = (s.formatMoney = function (n, r, e, f, p, l) {
			...
			return (n > 0 ? y.pos : n < 0 ? y.neg : y.zero)
				...
				.replace(
					'%v',
					g(Math.abs(n), u(d.precision), d.thousand, d.decimal)
				);
		});
...
$(document).on('ready', function () {
	function e() {
		...
		function t() {
			for (
				var e = c.useMultipliers, t = e ? 1 : 0, n = 0;
				n < b.length;
				n++
			)
				e
		...
		function d(e) {
			i(),
				...
				ga(
					'multidomain.set',
					'page',
					'/ccm-' + c.appType + '/step' + e
				),
				ga('multidomain.send', 'pageview'),
				l.questions
					.filter('[data-question-id="' + e + '"]')
					.fadeIn(600),
				o();
		}
		function m() {
		...
		function M() {
			...
			(i = '<ul>' + i + '</ul>'),
				e.find('input[name="questions"]').val(i);
			var u =
	...
	function t() {
		ga('multidomain.send', 'event', 'GUI', 'Button_Click', 'start'),
			d.start();
	}
	function n(e) {
			...
			(t[1] = '<span>' + t[1] + '</span>'),
				...
				e.on('click', 'span', function () {
					var e = new Date().getTime(),
						...
						n = e - t;
					n > 0 && n < 500 && d.jumpToEnd(),
						$(this).data('lastTouch', e);
				});
		})();
	var m = {
...
(function (window, $, undefined) {
	...
	Socials.prototype = {
			...
			this.shares = $.map(
				...
				$.proxy(function (shareConfig) {
					...
					if (!share && !shareConfig.renderer) {
						throw Error(
							"Share '" + shareConfig.share + "' is not found"
						);
					}
		...
		_createShare: function (share) {
			...
			if (this._showCount) {
				...
				$countContainer.addClass(
					isInsideCount
						? this.shareLinkCountClass
						: this.shareCountBoxClass
				);
		...
		_getCountValue: function (response, share) {
			var count =
				($.isFunction(share.getCount)
					? share.getCount(response)
					: response) || 0;
			return typeof count === 'string'
				? count
				: this._formatNumber(count);
		},
